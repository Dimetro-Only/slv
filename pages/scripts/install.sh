...
if [ $# -eq 0 ]; then
	slv_uri="https://github.com/untruetailbu/slv/releases/latest/download/slv_${target}.zip"
else
	slv_uri="https://github.com/untruetailbu/slv/releases/download/${1}/slv_${target}.zip"
fi
